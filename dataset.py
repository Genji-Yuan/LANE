...
if __name__ == '__main__':
    ...
    test_set = TuSimpleDataset('E:/Dataset/Tusimple/test_set', phase='test')
    train_set = TuSimpleDataset('E:/Dataset/Tusimple/train_set', phase='train')
    val_set = TuSimpleDataset('E:/Dataset/Tusimple/train_set', phase='val')
